...
<head>
    ...
    <script>
        ...
        var apiInvoice = new apiInvoice();
        var apiTax = new apiTax();
...
<div class="container">
    ...
    <h2>Get QBO Tax Information</h2>
    <pre id="apiTax"></pre>
    <button  type="button" class="btn btn-success" onclick="apiTax.getTaxAgenies()">Get QBO Tax Information</button>
    <hr />

    <h2>Create an Invoice</h2>
    <pre id="apiInvoice"></pre>
    <button  type="button" class="btn btn-success" onclick="apiInvoice.createInvoice()">Create QBO Invoice</button>
    <hr />
